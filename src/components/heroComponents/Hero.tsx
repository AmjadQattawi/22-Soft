...
export default function Hero() {
  return (
    <motion.section
      ...
      id="home"
        //  animate-fade-up css  
      className=" bg-white text-black px-6 md:px-12 py-8 md:py-14 overflow-hidden"
    >

     
      <div className="max-w-7xl mx-auto gap-8 lg:gap-12 grid grid-cols-1 lg:grid-cols-2     items-center">
